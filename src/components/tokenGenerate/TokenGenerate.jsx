...
function TokenGenerate() {
    ...
    const handleSubmit = async (event, isTokenIssue = false) => {
        ...
        const appointmentDataToSend = {
            ...
            ContactNo: appointmentData.contactNo,
            EmployeeId: appointmentData.employeeId,
            SecondaryEmployeeId: appointmentData.secondaryEmployeeId,
            DoctorEmployeeId: appointmentData.doctorEmployeeId,
            ActualFromTime: appointmentData.actualStartTime,
            ActualToTime: appointmentData.actualEndTime,
            ActualFromTimeSecond: appointmentData.actualSecondStartTime,
            ActualToTimeSecond: appointmentData.actualSecondEndTime,
